  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50'}`}>
      ...
      <section className={`py-20 px-4 ${darkMode ? 'bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white' : 'bg-gradient-to-br from-green-500 via-emerald-500 to-teal-600 text-white'}`}>
          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-16">
            <div className="space-y-8 lg:w-1/2">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <button className={`px-8 py-4 font-bold transition-all duration-300 rounded-xl ${darkMode
                  ? 'bg-gradient-to-r from-green-500 to-emerald-500 text-white hover:from-green-600 hover:to-emerald-600 shadow-lg hover:shadow-xl'
                  : 'bg-white text-green-600 hover:bg-green-50 shadow-lg hover:shadow-xl'
                  } transform hover:scale-105`}>
                  Meet Our Farmers
                </button>
                <button className={`px-8 py-4 font-bold transition-all duration-300 border-2 rounded-xl ${darkMode
        ...
        rounded-3xl overflow-hidden border-4 transform rotate-3
      ...
      `}
        ...
        w-36 h-36 lg:w-48 lg:h-48
        rounded-2xl overflow-hidden border-4 transform -rotate-6
        transition-transform duration-300 ease-out
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12">
            {[
              ...
              <div
                key={index}
                className={`p-8 lg:p-10 rounded-2xl transition-all duration-300 hover:shadow-2xl group transform hover:-translate-y-2 ${darkMode
              ...
              >
                <div className={`text-6xl mb-8 transition-transform duration-300 group-hover:scale-110 ${darkMode ? 'filter brightness-110' : ''
                  }`}>
                  {item.icon}
                </div>
      ...
      {/* <section className={`py-20 px-4 ${darkMode ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white' : 'bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50'}`}>
        <div className="mx-auto max-w-7xl">
          <div className="mb-20 text-center">
            ...
            <p className={`max-w-3xl mx-auto text-xl ${darkMode ? 'text-gray-300' : 'text-gray-600'
              }`}>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={index}
                className={`rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 group ${darkMode
  ...
  `}
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-20 text-center">
            <h2
              className={`mb-6 text-4xl lg:text-5xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'
                }`}
            >
              Meet Our Leader
            </h2>
            {/* <p
              className={`max-w-3xl mx-auto text-xl ${darkMode ? 'text-gray-300' : 'text-gray-600'
                }`}
            >
              Passionate individuals working together to revolutionize the grocery industry
            </p> */}
            ...
            >
              A solo entrepreneur on a mission to transform the grocery experience.
            </p>
            <div className="w-32 h-1.5 mx-auto mt-8 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full"></div>
          </div>
          ...
          {/* <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={idx}
                className={`
            rounded-2xl overflow-hidden transition-transform duration-300 ease-out hover:scale-105 hover:shadow-2xl group
            ${darkMode
          ...
          `}
            ...
            `}
                ...
                <div className="p-6 text-center">
                  <h3
                    className={`mb-3 text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'
                      }`}
                  >
                    {member.name}
                  </h3>
          ...
          <div className="mt-16 text-center">
            <p className={`mb-6 font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
              This E‑commerce site developed by
              <span className={`ml-1 font-bold ${darkMode ? 'text-green-400' : 'text-green-600'}`}>
                Md. Mostofa Hasib
              </span>
            </p>
            ...
            <div className="inline-flex items-center space-x-6">
              {/* Your Photo */}
              <div className="w-24 h-24 overflow-hidden transition-transform duration-300 ease-out border-4 border-green-500 rounded-full hover:scale-110">
                <img
                  src="/images/hasib.png"
                  alt="Md. Mostofa Hasib"
              ...
              <div className="space-y-2 text-left">
                <a
                  href="mailto:hasibammostofahasib@gmail.com"
                  className={`block transition-colors hover:text-green-500 ${darkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}
                >
                  📧 hasibammostofahasib@gmail
                </a>
                <a
                  href="https://github.com/Hasib2202"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`block transition-colors hover:text-green-500 ${darkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}
                >
                  🐱 https://github.com/Hasib2202
                </a>
                <a
                  href="https://www.linkedin.com/in/md-mostofa-hasib-5b4027184/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`block transition-colors hover:text-green-500 ${darkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}
                >
                  💼 linkedin.com/in/mostofa-hasib
                </a>
                <a
                  href="https://mostofahasib.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`block transition-colors hover:text-green-500 ${darkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}
      ...
      {/* Stats Section */}
      <section className={`py-20 px-4 ${darkMode
      ...
      <section className={`py-20 px-4 ${darkMode ? 'bg-gray-900 text-white' : 'bg-white'}`}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className={`max-w-3xl mx-auto mb-12 text-xl leading-relaxed ${darkMode ? 'text-gray-300' : 'text-gray-600'
            }`}>
